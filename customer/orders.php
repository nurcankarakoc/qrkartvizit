...
<head>
    ...
    <style>
        ...
        @media (max-width: 900px) {
            ...
            .order-head { flex-direction: column; align-items: flex-start; gap: 0.8rem; }
            .top-bar { flex-direction: column; align-items: stretch !important; gap: 1rem; padding: 1.25rem 1rem !important; margin-bottom: 2rem; }
            .top-bar > div:last-child { flex-direction: column; align-items: stretch; gap: 0.75rem; }
            .btn-lite { justify-content: center; width: 100% !important; }
            .top-bar > div:last-child > div { text-align: center; width: 100%; }
        }
        @media (max-width: 480px) {
            .order-card { padding: 1rem; border-radius: 16px; }
        ...
        <header class="top-bar">
            ...
            <div style="display:flex; align-items:center; gap:0.6rem;">
                <?php if (!$can_create_order): ?>
                    <a href="profile.php" class="btn-lite" style="margin:0;">Web Sitesini Güncelle</a>
                <?php endif; ?>
                <a href="new-order.php" class="btn-lite" style="margin:0;">Yeni Sipariş</a>
        ...
        <div class="content-wrapper">
            <?php if (empty($orders)): ?>
                <div class="order-card" style="text-align: center; padding: 2rem;">
                    ...
                    <a href="new-order.php" class="btn-lite" style="display: inline-flex;">Yeni Sipariş Başlat</a>
                </div>
            <?php else: ?>
                    ...
                    <?php foreach ($orders as $order): ?>
                        ...
                        <article class="order-card">
                            ...
                            <div class="order-actions">
                                <a class="btn-lite" href="order-details.php?id=<?php echo (int)$order['id']; ?>"><i data-lucide="file-text"></i> Detayı Gör</a>
    ...
    <script>
        ...
        if (!CAN_CREATE_ORDER) {
            document.querySelectorAll('a[href="new-order.php"]').forEach((link) => {
                if (link.closest('.top-bar') || link.closest('.order-card')) {
