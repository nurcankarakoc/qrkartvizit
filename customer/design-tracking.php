...
$error_messages = [
    ...
    'invalid_transition' => 'Baskı onayı verildikten sonra basılı kartvizit tasarımı için revize veya değişiklik talebi açılamaz.',
...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .btn-premium-approve, .btn-premium-revise { width: 100%; justify-content: center; }
            .top-bar { flex-direction: column; align-items: stretch; gap: 1rem; padding: 1.5rem !important; }
            .top-bar > div:last-child { text-align: left !important; display: flex; flex-direction: row; justify-content: space-between; align-items: center; border-top: 1px solid #e2e8f0; padding-top: 0.5rem; }
            .top-bar > div:last-child > div:first-child { margin-bottom: 0 !important; }
            .design-card { padding: 1.5rem 1rem; }
                ...
                <div class="design-card">
                    <?php if (!$order): ?>
                        <div style="padding: 4rem 2rem;">
                            ...
                            <p style="color: #64748b; margin-top:1rem;">Baskılı veya dijital kartvizit siparişinizi müşteri panelinden doğrudan oluşturabilirsiniz.</p>
                            <a href="new-order.php" class="btn-premium-approve" style="margin-top:1.25rem; display:inline-flex;">
                    ...
                    <?php else: ?>
                        ...
                        <?php if ($has_draft && in_array($order_status, ['designing', 'awaiting_approval', 'revision_requested'], true)): ?>
                            <div class="action-hub">
                                ...
                                <div style="display:flex; align-items:center; justify-content:center; padding:0.8rem 1rem; border:1px solid #fde68a; background:#fffbeb; color:#92400e; border-radius:14px; font-weight:700; max-width:320px;">
                                    Baskı onayı sonrası tasarım kilitlenir.
                                </div>
                            ...
                            <?php else: ?>
                                <div class="revision-form-container" style="display:block; text-align:left;">
                                    <h4 style="font-weight: 800; color: var(--navy-blue); margin-bottom: 0.9rem;">Revize Hakk? Tamamland?</h4>
                                    <p style="margin:0; color:#64748b; font-size:0.92rem;">Bu sipari? i?in tan?ml? revize hakk? kullan?ld?. Yeni de?i?iklik i?in yeni sipari? olu?turabilirsiniz.</p>
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                    <?php endif; ?>
